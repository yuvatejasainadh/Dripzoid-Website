    ...
    <div className={`min-h-screen bg-background ${isDarkMode ? "dark" : ""}`}>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6">ACCESSORIES</h1>
          <p className="text-xl text-muted-foreground mb-8">
            Complete your drip with the perfect accessories! We're building a
            collection of bags, caps, jewelry, and more to elevate your
            streetwear game.
          </p>

          <div className="bg-brand-brown/10 border border-brand-brown/20 rounded-lg p-8 mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-brand-brown">
              Coming Soon!
            </h2>
            <p className="text-muted-foreground mb-4">
              Our accessories line will include streetwear essentials like
              bucket hats, chain necklaces, crossbody bags, phone cases, and
              statement pieces to complete your look.
            </p>
          ...
          <p className="text-sm text-muted-foreground">
            While you wait, explore our clothing collections:{" "}
            <Link to="/men" className="text-neon-blue hover:underline">
              Men
            </Link>{" "}
            •{" "}
            <Link to="/women" className="text-neon-blue hover:underline">
              Women
            </Link>
          </p>
        </div>
