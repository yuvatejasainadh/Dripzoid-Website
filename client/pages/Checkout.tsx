        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center max-w-md mx-auto">
            ...
            <p className="text-muted-foreground mb-6">
              Thank you for shopping with DRIPZOID. Your order #DZ
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="border border-border rounded-lg p-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handlePaymentChange("cardExpiry", e.target.value)
                        }
                        className="w-full px-3 py-2 border border-border rounded-lg"
                        placeholder="MM/YY"
                        maxLength={5}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handlePaymentChange("cardCvv", e.target.value)
                        }
                        className="w-full px-3 py-2 border border-border rounded-lg"
                        placeholder="123"
                        maxLength={3}
              ...
              {selectedPayment === "cod" && (
                <div className="space-y-4 border-t border-border pt-4">
                  <p className="text-sm text-muted-foreground">
                    Pay ₹{total} when your order is delivered. Cash on delivery
                    is available for orders up to ₹50,000.
                  </p>
                </div>
              )}
            </div>
