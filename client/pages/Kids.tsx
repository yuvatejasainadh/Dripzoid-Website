      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Mini drip for mini humans! We're working on an awesome kids
            collection that'll make the little ones look as cool as their
            parents.
          </p>
          ...
          <div className="bg-neon-green/10 border border-neon-green/20 rounded-lg p-8 mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              Our kids collection will feature age-appropriate streetwear
              including mini hoodies, cool tees, comfortable joggers, and fun
              accessories for ages 2-14.
            </p>
          ...
          <p className="text-sm text-muted-foreground">
            For now, check out our adult collections:{" "}
